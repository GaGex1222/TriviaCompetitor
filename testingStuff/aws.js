...
var config = {
    region: "eu-north-1",
    credentials: {
        accessKeyId: "AKIA4MI2JR23QKL7JMN2",
        secretAccessKey: "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"
    }
};
console.log("HLELOLOL");
// Function to upload a file to AWS S3
var uploadFileAWS = function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, fileStream, input, command, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                client = new client_s3_1.S3Client(config);
                // Ensure the file exists at the specified path
                if (!fs.existsSync("MedalTVRoblox20241119024741.mp4")) {
                    console.error("File not found: MedalTVRoblox20241119024741.mp4");
                    return [2 /*return*/];
                }
                fileStream = fs.createReadStream("MedalTVRoblox20241119024741.mp4");
                input = {
